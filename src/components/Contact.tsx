        ...
        <div className="grid lg:grid-cols-5 gap-10 max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={staggerItem} className="pt-2">
              <p className="text-xs text-muted uppercase tracking-wider mb-4">Connect With Me</p>
              <div className="flex gap-3">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className={`w-12 h-12 rounded-xl glass border border-border/50 flex items-center justify-center text-muted transition-all ${link.color}`}
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="btn-primary w-full text-center py-4 rounded-xl inline-flex items-center justify-center gap-2 text-base"
            >
              <Download size={18} />
              Download Resume
            </motion.a>
            ...
            <div className="glass rounded-2xl p-6 md:p-8 relative overflow-hidden">
              ...
              {isSubmitted && (
                <motion.div
                  ...
                  className="absolute inset-0 bg-bg-card/95 backdrop-blur-sm flex flex-col items-center justify-center z-10 rounded-2xl"
                >
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                  ...
                  <h3 className="text-xl font-heading font-semibold text-text mb-2">Message Sent!</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-bg/50 border border-border/50 text-text placeholder:text-muted/50 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all text-sm"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-bg/50 border border-border/50 text-text placeholder:text-muted/50 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all text-sm resize-none"
                  />
                </div>
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="btn-primary w-full py-4 rounded-xl inline-flex items-center justify-center gap-2 text-base disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
                      <motion.div
